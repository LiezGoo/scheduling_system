    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            editSubjectForm.addEventListener('submit', function(e) {
                ...
                const lectureHours = parseFloat(document.getElementById('edit_lecture_hours').value) || 0;
                const labHours = parseFloat(document.getElementById('edit_lab_hours').value) || 0;
                if (lectureHours <= 0 && labHours <= 0) {
                    editSubjectAlert.className = 'alert alert-danger';
                    editSubjectAlert.textContent = 'Lecture hours and lab hours cannot both be 0.';
