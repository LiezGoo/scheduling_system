    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            addSubjectForm.addEventListener('submit', function(e) {
                ...
                const lectureHours = parseFloat(document.getElementById('add_lecture_hours').value) || 0;
                const labHours = parseFloat(document.getElementById('add_lab_hours').value) || 0;
                if (lectureHours <= 0 && labHours <= 0) {
                    addSubjectAlert.className = 'alert alert-danger';
                    addSubjectAlert.textContent = 'Lecture hours and lab hours cannot both be 0.';
                ...
                fetch('{{ route('department-head.subjects.store') }}', {
                        method: 'POST',
                        body: formData,
                        headers: {
