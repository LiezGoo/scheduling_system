                ...
                <div class="card-body p-4">
                    ...
                    <form id="scheduleConfigForm">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select focus-maroon" id="semester" name="semester" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select focus-maroon" id="yearLevel" name="year_level" required>
...
<script>
    ...
    function prepareGeneration() {
        ...
        document.getElementById('modalSemester').textContent    = form.semester.value;
        document.getElementById('modalYear').textContent        = form.year_level.options[form.year_level.selectedIndex].text;
    ...
    function switchBlock(idx) {
        ...
        const items = allGeneratedSchedules[idx]?.items || [];
