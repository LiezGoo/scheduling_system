                            ...
                            <tr>
                                <td
                                    ...
                                    <a href="{{ $url }}" class="button button-{{ $color ?? 'primary' }}"
                                        ...
                                        style="font-family: Helvetica, Arial, sans-serif; box-sizing: border-box; border-radius: 6px; color: #fff; cursor: pointer; display: inline-block; overflow: hidden; text-decoration: none; font-weight: 600; background-color: @if ($color === 'success') #48bb78 @elseif ($color === 'error') #e53e3e @else #8B0000 @endif; border-bottom: 8px solid @if ($color === 'success') #38a169 @elseif ($color === 'error') #c53030 @else #5A0000 @endif; border-left: 18px solid @if ($color === 'success') #48bb78 @elseif ($color === 'error') #e53e3e @else #8B0000 @endif; border-right: 18px solid @if ($color === 'success') #48bb78 @elseif ($color === 'error') #e53e3e @else #8B0000 @endif; border-top: 8px solid @if ($color === 'success') #38a169 @elseif ($color === 'error') #c53030 @else #5A0000 @endif; padding: 12px 30px; text-transform: capitalize;">
                                        {{ $slot }}
                                    </a>
                                </td>
                            </tr>
