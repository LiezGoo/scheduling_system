    ...
    <div class="container-fluid py-4" id="curriculumPage">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('program-head.curriculum.index') }}" id="programSelectForm" class="row g-3">
        ...
        <div class="card shadow-sm mb-4" id="subjectSelection">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('program-head.curriculum.store') }}" id="assignmentForm">
                    @csrf
