...
<script>
    ...
    function executeDelete(id) {
        ...
        setTimeout(() => {
            ...
            document.getElementById('successMessage').textContent = 'Semester has been deleted.';
            successModal.show();
    ...
    function executeToggleStatus(id) {
        ...
        setTimeout(() => {
            ...
            document.getElementById('successMessage').textContent = 'Semester status has been updated.';
            successModal.show();
