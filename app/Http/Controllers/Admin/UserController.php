...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (!in_array($validated['role'], [User::ROLE_ADMIN, User::ROLE_DEPARTMENT_HEAD, User::ROLE_PROGRAM_HEAD])) {
    ...
    public function update(Request $request, User $user)
    {
        ...
        if (in_array($validated['role'], [User::ROLE_ADMIN, User::ROLE_STUDENT], true)) {
